...
IMAGE_WIDTH=224
IMAGE_CHANNELS=3
#os.chdir(r'C:\Users\Srikanth PC\DataScience\data')
...
def upload_image():
    if 'image' not in request.files:
        return render_template('imageml.html', prediction="No posted image. Shoulld be attribute named image")
